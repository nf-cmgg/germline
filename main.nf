...
params.alphamissense        = WorkflowMain.getGenomeAttribute(params, 'alphamissense')
params.alphamissense_tbi    = WorkflowMain.getGenomeAttribute(params, 'alphamissense_tbi')
