...
| `fasta` | Path to FASTA genome file. <details><summary>Help</summary><small>This parameter is *mandatory* if `--genome` is not specified. The path to the reference genome fasta.</small></details>| `string` |  | :heavy_check_mark: |  |
